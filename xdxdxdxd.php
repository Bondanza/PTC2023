            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">
                            <img src="images/Logo1.png" align="klassy cafe html template">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                ...
                <div class="col-lg-4">
                    <div class="left-content">
                        <div class="inner-content">
                            <h4> EcoSurf Restaurante </h4>
                            <h6> La mejor comida </h6>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-heading">
                        <h6> Nuestro Menu </h6>
                        <h2> Nuestra amplia seleccion de platos de comida </h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="owl-menu-item owl-carousel">
                    ...
                    <div class="item">
                        <div class='card card3'>
                            ...
                            <div class='info'>
                              <h1 class='title'> Coctel de conchas </h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card4'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Pizza marinera</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card5'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Pasta alfredo de camarones</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card6'>
                            ...
                            <div class='info'>
                              <h1 class='title'>Carpaccio de Pescado</h1>
                              <p class='description'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sedii do eiusmod teme.</p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
